...
namespace WebApplication1
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        string ryuTextBul1 = "<br><br><h1>Ryu: The Big Adventure!</h1><br><em>2D Екшън игра. Написана е на Java и представлява 2D Beat 'em up симулатор.</em><br><br>" +
            "<h2>Описание</h2><br><b>Ryu: The Big Adventure</b> е подобие на аркадните игри <b>Cadillacs and Dinosaurs, Contra, Metal Slug, Streets of Rage, Golden Axe</b> и още много други." +
            "<br><br><h2>Функции</h2><br>Играта „Ryu: The Big Adventure” предоставя на потребителите възможността да играят на един типичен хоризонтален beat 'em up симулатор." + 
        ...
        string ryuTextBul2 = "<br><br><h1>Ryu: The Big Adventure!</h1><br><em>2D Екшън игра. Написана е на Java и представлява 2D Beat 'em up симулатор.</em><br><br>" +
            ...
            "Над индикатора за енергията има и още един индикатор за здравето на Ryu, обозначен като HP. То също е изобразено чрез 8 правоъгълника, но в червено. За разлика от енергията," +
            ...
            " когато преминем през някакво препядствие, като огън. Когато здравето ни се изчерпа нашият герой умира и играта приключва.<br>Освен тези два индикатора имаме и време." +
            ...
            "се възобновява след като преминем част от нивото, примерно средата на нивото.<br>Освен да използва основната игрова функционалност, потребителят може също да спира и пуска" +
            ...
            "минимизирана.<br><br><h2>Софтуерни ограничения</h2><br>За ползване на играта Ryu: The Big Adventure е необходима инсталацията на JRE " +
            ...
            "<b><u>Link</u></b></a><br><br><h2>Допускания и зависимости</h2><br>Достъпът до дистрибуцията на играта е зависим от GitHub, уеб хранилището" +
            "за разполагане на софтуерни проекти и техните съвместни разработки върху отдалечен интернет сървър.<br>Проектът прави допускането и разчита, че порталът GitHub, който се" +
            "поддържа от трета страна, е достъпен и в изправност.Прави се също допускането, че крайните потребители разполагат със съвместим персонален компютър с инсталират Java Runtime" +
            ...
            "разпространение на играта.<br><br><h2>Диаграма на състоянията</h2><br>Диаграмата на състоянията в този раздел показва как играта Ryu: The Big Adventure " +
            "трябва да обработва заявките на крайния потребител.<br>Диаграмата е изградена чрез Унифицираният език за моделиране (UML), който е графичен език за конструиране и документиране на " +
            "елементите на една софтуерна система.<br><br><img src=\"/Resources/ryu4.png\" width=\"592\" height=\"400\"><a href=\"/Resources/ryu4.png\"" +
            "target=\"_blank\"><b><u>Оригинален размер</u></b></a><br><br>В проекта се използват 4 различни състояния, едно за менюто, второто за настройките, третото е „За Автора“ и" +
        ...
        string ryuTextBul3 = "<br><br><h1>Ryu: The Big Adventure!</h1><br><em>2D Екшън игра. Написана е на Java и представлява 2D Beat 'em up симулатор.</em><br><br>" +
            "<h2>Реализация</h2><br><h3>Потребителско меню</h3><br>Първата цел при създаването на проекта е да се направи начално потребителско меню.<br><br><img src=\"/Resources/ryu5.jpg\" width=\"592\">" +
            "Основните събития, за които контролерът е „абониран“ е началото на нова игра (при натискане на бутон „Start Game“), показването на екран с настройки, екран „За Автора“ и изход от приложението." +
            " В менюто е изобразен и главният ни герой, в която роля се очаква да влезем.<br><br><h3>Настройки</h3><br>Менюто с настройките съдържа две маркиращи квадратчета, за включване и изключване на музиката" + 
            ...
            "В менюто с настройките са използвани глобални променливи, които са достъпни до всеки един клас. Те се обявяват в главното меню, променят се в менюто с настройките и се прочитат от всяко едно събитие." +
            " Така звукът и музиката работят еднакво, във всяко едно състояние.<br><br><img src=\"/Resources/ryu6.jpg\" width=\"592\">Трудността оказва влияние на издръжливостта на противниците. Когато трудността" +
            ...
            " повишава до 150%.<br>Слайдера за музиката използва метода  music.setVolume(float volume); за промяна на силата на музиката и music.getVolume(float volume); за да прочита каква е силата в момента " +
            "и да променя собственото си състояние.<br>Слайдера за звуците използва своя собствена глобална променлива, вместо методите  setVolume и getVolumе поради това, че силата на звукът им се декларира," + 
            ...
            " следния начин: <br>punchedSnd.play(1, Menu.soundVolume);<br>В горната команда звукът punchedSnd бива прозвирен чрез метода play. 1 представлява стъпката на звукът а променливата  soundVolume се " +
            "извиква от класът Menu и контролира неговата му сила.<br>За маркиращите квадратчета са използвани булевите soundOn и musicOn.<br><br><h3>За автора</h3><br>Credits или „За автора“ е най-просто изграденото " + 
