...
namespace WebApplication1
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        string ryuTextBul2 = "<br><br><h1>Ryu: The Big Adventure!</h1><br><em>2D Екшън игра. Написана е на Java и представлява 2D Beat 'em up симулатор.</em><br><br>" +
            ...
            "минимизирана.<br><br><h3><span class=\"tab\">Софтуерни ограничения</span></h3><br>За ползване на играта Ryu: The Big Adventure е необходима инсталацията на JRE " +
            ...
            "<b><u>Link</u></b></a><br><br><h3><span class=\"tab\">Допускания и зависимости</span></h3><br>Достъпът до дистрибуцията на играта е зависим от GitHub, уеб хранилището" +
            ...
            "разпространение на играта.<br><br><h3><span class=\"tab\">Диаграма на състоянията</span></h3><br>Диаграмата на състоянията в този раздел показва как играта Ryu: The Big Adventure " +
