...
namespace WebApplication1
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        string ryuTextBul6 = "<br/><br/><h1>Ryu: The Big Adventure!</h1><br/><em>2D Екшън игра. Написана е на Java и представлява 2D Beat 'em up симулатор.</em><br/><br/>" +
            ...
            "<span class=\"tab\"></span>Изкуственият интелект позволява на компютрите да правят неща, които за хората изглеждат разумни. Той има способност да анализира обкръжаващата го среда и да предприема действия, които увеличават възможността за постигане " +
        ...
        string ryuTextEng6 = "<br/><br/><h1>Ryu: The Big Adventure!</h1><br/><em>2D Action game. Written in Java it represents a 2D Beat 'em up simulator.</em><br/><br/>" +
            "<h2>Realization</h2><br/><h3>Creating enemies</h3><br/><span class=\"tab\"></span>The other important part of the game is creating the enemies, which will keep us busy throughout the level. They are created similarly to the main character – they are" +
            " created using spritesheets, they make sounds, they have health and they can hit. The difference here is that they are controlled by the computer using artificial intelligence (A.I.).<br/><span class=\"tab\"></span>" +
            "Each enemy is created using 5 different spritesheets: static animation, walking, hitting, being hit and a sprite for dying.<br/><span class=\"tab\"></span><span class=\"tab\"></span><span class=\"tab\"></span><span class=\"tab\">" +
            "<span class=\"tab\"></span><span class=\"tab\"></span></span><img src=\"/Resources/ryu10.png\" width=\"250\"><br/><span class=\"tab\"></span>The enemies are initialized in exact coordinates on the level. Unlike Ryu, the enemies don't have" +
            " special abilities which means that they don't have energy (MP) either. Only health (HP), which is defined by the level of difficulty.<br/><br/><h3>Creating artificial intelligence</h3><span class=\"tab\"></span><li><b>Overview</b></li><br/>" +
            "<span class=\"tab\"></span>Artificial intelligence alows computers to do things, which people can find reasonable. A.I. can analyze the surrounding environment and to make decisions, which increase the posibility to acomplish " +
            "given tasks.<br/><span class=\"tab\"></span>Creating of A.I. is one of the most complex stages when creating a computer game. It haves a ceparate segment in IT and it's an academic field of study." +
            "<br/><span class=\"tab\"></span>An example of great A.I. is that in the game F.E.A.R.: First Encounter Assault Recon. This is a FPS (First person shooter), in which computer entities have a variety of different actions. Enemies can duck to travel under crawlspaces, jump" +
            " through windows, vault over railings, climb ladders, and push over large objects to create cover. Various opponents may act as a team, taking back routes to surprise the player, using" +
